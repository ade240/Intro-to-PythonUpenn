...
def calculator():
    ...
    try:
        ...
        # if users enters negative number, print message
        ...
        if d_age == -1:
            ...
            h_age = d_age * 15
            print("The given dog age", age, "is", round(d_age * 15, 2), "in human years.")
        
            
        elif d_age <= 2:
            h_age = d_age * 12
            print("The given dog age", age, "is", round(d_age * 12, 2), "in human years.")
            
        elif d_age <= 3:
            h_age = d_age * 9.3
            print("The given dog age", age, "is", round(d_age * 9.3, 2), "in human years.")
            
        elif d_age <= 4:
            h_age = d_age * 8
            print("The given dog age", age, "is", round(d_age * 8, 2), "in human years.") 
            
        elif d_age == 5:
            h_age = d_age * 7.2
            print("The given dog age", age, "is", round(d_age * 7.2, 2), "in human years.")
            
        elif d_age == 6:
            h_age = d_age * (5 * 7.2 + (6-5) * 7)
            print("The given dog age", age, "is", round((5 * 7.2 + (6-5) * 7), 2), "in human years.")
            
        elif d_age == 7:
            h_age = d_age * (5 * 7.2 + (7-5) * 7)
            print("The given dog age", age, "is", round((5 * 7.2 + (7-5) * 7), 2), "in human years.")
